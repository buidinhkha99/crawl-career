...
namespace Salt\NovaFlexibleContent\Layouts;
...
use Salt\NovaFlexibleContent\Concerns\HasFlexible;
use Salt\NovaFlexibleContent\Flexible;
...
class Layout implements LayoutInterface, JsonSerializable, ArrayAccess, Arrayable
{
     ...
     *
     * @param  Salt\NovaFlexibleContent\Layout  $layout
     * @return mixed
     */
