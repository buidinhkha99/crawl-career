...
use Salt\NovaFlexibleContent\Http\ScopedRequest;
use Salt\NovaFlexibleContent\Layouts\Collection as LayoutsCollection;
use Salt\NovaFlexibleContent\Layouts\Layout;
use Salt\NovaFlexibleContent\Layouts\LayoutInterface;
use Salt\NovaFlexibleContent\Layouts\Preset;
use Salt\NovaFlexibleContent\Value\Resolver;
use Salt\NovaFlexibleContent\Value\ResolverInterface;
...
class Flexible extends Field
{
     ...
     *
     * @var Salt\NovaFlexibleContent\Layouts\Collection
     */
    protected $layouts;
     ...
     *
     * @var Salt\NovaFlexibleContent\Value\ResolverInterface
     */
    protected $resolver;
     ...
     *
     * @param  Salt\NovaFlexibleContent\Layouts\LayoutInterface  $layout
     * @return void
     */
    ...
    {
        $groups = $groups->map(fn ($group) => json_encode($group->getResolved()));

        return $groups->map(fn ($group) => json_decode($group));
    }
    ...
    {
        $groups = $groups->map(fn ($group) => json_encode($group->getResolvedForDisplay()));
     ...
     *
     * @param  string  $key
     * @return \Salt\NovaFlexibleContent\Layouts\Layout
     */
     ...
     *
     * @param  string  $key
     * @return null|\Salt\NovaFlexibleContent\Http\FlexibleAttribute
     */
    ...
    /**
     * Push list image layout for attach
     */
    public function addLayoutImagesAttach(array $layout_images): void
    {
        $this->withMeta(['layout_images_attach' => $layout_images]);
    }
}
