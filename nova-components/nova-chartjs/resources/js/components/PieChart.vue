<template>
  <loading-card :loading="loading" class="min-h-40">
    <div class="h-6 flex items-center px-6 mt-4">
      ...
      <line-chart style="height: 152px" v-if="!loading && JSON.parse(JSON.stringify(this.datacollection)).labels && JSON.parse(JSON.stringify(this.datacollection))?.labels?.length > 0" :chart-data="datacollection" :options="options"></line-chart>
