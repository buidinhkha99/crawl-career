...
class NumberAnswerQuestions extends Value
{
    ...
    {
        return __('Total number of responses to review questions');
    }
    /**
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        $model = $this->globalFiltered($request, QuestionUser::class,[
            StartTimeFilter::class,
            EndTimeFilter::class
        ]);
        
        // withoutSuffixInflection delete auto add suffix 's'
        return $this->result($model->count())->suffix(__('times'))->withoutSuffixInflection();
    }
