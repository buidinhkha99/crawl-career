...
class NumberQuizzesFilter extends Value
{
    use GlobalFilterable;
    public $icon = 'document-text';
    public function name()
    {
        return __('Number Quizzes');
    }
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        return $this->result($model->select('id')->withCount('quizzes')->get()->sum('quizzes_count'))->suffix(__('quizzes'))->withoutSuffixInflection();
    }
