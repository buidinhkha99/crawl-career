...
class NumberUsersFilter extends Value
{
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        return $this->result($model->select('id')->manageRoles()->count())->suffix(__('user'))->withoutSuffixInflection();
    }
