...
class MockQuiz extends Model implements Sortable
{
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope(new MockQuizScope);
    }
    ...
    protected function negativeMarkingSettings(): Attribute
    {
        return Attribute::make(
            get: fn ($value) => empty($value) ? [
                ...
                'negative_marking_type' => MockQuiz::FIXED_NEGATIVE_TYPE,
